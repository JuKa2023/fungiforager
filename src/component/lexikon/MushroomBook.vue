<template>
  <div class="book-wrapper w-full flex justify-center items-center py-4 md:p-8">
    ...
    <div class="mobile-carousel md:hidden w-full max-w-md mx-auto px-4">
      <div class="book relative w-full aspect-[3/5] sm:aspect-[3/4] shadow-xl rounded-lg overflow-hidden bg-[#E5BE7F] flex flex-col">
        ...
        <div class="absolute bottom-4 left-0 right-0 flex justify-between px-6 pointer-events-none z-20">
          <button
            @click="prevMobile"
