<template>
  <main class="lexikon-page min-h-screen relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 py-10 relative z-10">
      ...
      <div v-else-if="mushrooms.length === 0" class="text-center text-[#e0d5c1] p-8 bg-black/20 rounded-lg">
        <p class="text-xl font-serif">🍄 Es konnten keine Pilze im Wald gefunden werden, komme später wieder.</p>
      </div>
